    ...
    >
      <div className="container mx-auto px-4 h-16 md:h-20 flex items-center justify-between">
        ...
        >
          ...
          <span className={isScrolled ? "text-foreground" : "text-black"}>book</span>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link 
            to="/" 
            className={`navbar-link ${isScrolled ? "text-foreground" : "text-black"} ${isActive("/") ? "navbar-link-active" : ""}`}
          >
            Home
          </Link>
          <Link 
            to="/photographers" 
            className={`navbar-link ${isScrolled ? "text-foreground" : "text-black"} ${isActive("/photographers") ? "navbar-link-active" : ""}`}
          >
            Photographers
          </Link>
          <Link 
            to="/appointment" 
            className={`navbar-link ${isScrolled ? "text-foreground" : "text-black"} ${isActive("/appointment") ? "navbar-link-active" : ""}`}
          >
            Appointment
          </Link>
          <Link 
            to="/albums" 
            className={`navbar-link ${isScrolled ? "text-foreground" : "text-black"} ${isActive("/albums") ? "navbar-link-active" : ""}`}
          >
            Albums
          </Link>
          <Link 
            to="/contact" 
            className={`navbar-link ${isScrolled ? "text-foreground" : "text-black"} ${isActive("/contact") ? "navbar-link-active" : ""}`}
          >
            Contact
          </Link>
